...
data class AnimeInfo(
    ...
    @SerialName("rates_scores_stats") val ratesScoresStats: List<IntNamedStat>? = null,
...
fun AnimeInfo.toDomainAnimeInfo(): DomainAnimeInfo {
    return DomainAnimeInfo(
        ...
        topicId,
        myAnimeListId,
        ratesScoresStats?.map { it.toDomainNamedStat() }.orEmpty(),
        ratesStatusesStats?.map { it.toDomainNamedStat() }.orEmpty(),
        updatedAt,
        nextEpisodeAt,
        fansubbers,
        fandubbers,
